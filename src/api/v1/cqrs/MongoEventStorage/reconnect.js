...
function* reconnect(
  connectMethod,
  { retries, timeout = 5000, debug = console.warn } = {},
) {
  if (typeof connectMethod !== "function")
    throw new TypeError("connectMethod argument must be a Function");
  if (typeof timeout !== "number" || !timeout)
    throw new TypeError("timeout argument must be a Number");
  if (typeof debug !== "function")
    throw new TypeError("debug argument must be a Function");
...
export default co.wrap(reconnect);
